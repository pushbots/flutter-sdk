...
enum LOG_LEVEL { DEBUG, VERBOSE, INFO, WARNING, ERROR, WTF, NONE }

class PushbotsFlutter {
  static const MethodChannel _channel = const MethodChannel('pushbots_flutter');
  ...
  static Future<dynamic> initialize(String id, String webApiKey, String fcmAppId, String projectId) async {
  ...
  static Future<String> setLogLevel(LOG_LEVEL logcatLevel, LOG_LEVEL uiLevel) {
    return _channel.invokeMethod("setLogLevel", <String, dynamic>{
      'logcatLevel': logcatLevel.toString(),
      'uiLevel': uiLevel.toString(),
    });
  }
